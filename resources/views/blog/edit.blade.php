    ...
    <div class="w-4/5 mx-auto">
        ...
        <div class="m-auto pt-20">
            ...
            <form action="{{ route('blog.update', $post->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <input type="checkbox" {{ $post->is_published === true ? 'checked' : '' }} class="bg-transparent inline border-b-2 text-2xl outline-none"
                    name="is_published">
                ...
                <input type="text" name="meta_robots" value="{{ $post->meta_robots }}"
